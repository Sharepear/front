System.register("components/album/chromatic", ["angular2/angular2"], function($__export) {
  "use strict";
  ...
  return {
    ...
    execute: function() {
      AlbumChromatic = $__export("AlbumChromatic", (function() {
        var AlbumChromatic = function AlbumChromatic() {
          console.log('component Chromatic mounted');
          $('.album-chromatic').chromatic(this.getPhotos());
        };
        return ($traceurRuntime.createClass)(AlbumChromatic, {
          onDestroy: function() {
      ...
      Object.defineProperty(AlbumChromatic, "annotations", {get: function() {
          return [new Component({
            selector: 'album-chromatic',
            lifecycle: ['onDestroy']
          }), new View({templateUrl: 'components/album/chromatic.html'})];
        }});
    }
  };
});
