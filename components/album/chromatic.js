System.register("components/album/chromatic", ["angular2/angular2", "components/album/service", "components/router/service", "components/image/upload"], function($__export) {
  "use strict";
  var __moduleName = "components/album/chromatic";
  var Component,
      Template,
      If,
      For,
  ...
  return {
    ...
    execute: function() {
      Chromatic = $__export("Chromatic", (function() {
        ...
        return ($traceurRuntime.createClass)(Chromatic, {remove: function() {
            this.routerService.displayAlbumList();
            this.albumService.remove(this.albumService.album);
          }}, {});
      }()));
      Object.defineProperty(Chromatic, "annotations", {get: function() {
          return [new Component({
            selector: 'chromatic',
            services: [AlbumService]
          }), new Template({
            inline: '<div id="chromatic"></div>',
